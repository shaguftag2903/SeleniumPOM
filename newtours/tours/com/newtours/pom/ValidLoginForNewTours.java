...
public class ValidLoginForNewTours extends UtilityClass {
	...
	public void loginTest() throws TimeoutException, ElementNotVisibleException, Exception {
		try {
			...
			log.add("2: Enter the UserName:" + Constants.userName1);
			log.add("3: Enter the Password:" + Constants.password1);
			Reporter.log("Button is clicked successfully");
			log.add("4: Login Successfull");
			
			Assert.assertNotEquals(URL, "verificationURL1");
	...
	public void tearDown() throws COSVisitorException, IOException {
		...
		pdfResult.writeTestResultToPdfFile("ResultForValidLogin.pdf", log);
		// quit the driver
		driver.quit();
